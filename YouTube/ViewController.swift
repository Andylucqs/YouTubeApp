...
class HomeController: UICollectionViewController, UICollectionViewDelegateFlowLayout{
    ...
    // Делегат UICollectionViewDelegateFlowLayout делает ячейки горизонтальными
...
class VideoCell: UICollectionViewCell {
    ...
    func setupViews() {
        ...
        addConstraintWithFormat(format: "V:|-16-[v0]-8-[v1(44)]-16-[v2(1)]|", view: thumbnailImageView, userProfileImageView, separatorView)
...
//                                     titleLabel.leftAnchor.constraint(equalTo: userProfileImageView.rightAnchor, constant: 8),
...
//        NSLayoutConstraint.activate([subtitleTextView.topAnchor.constraint(equalTo: titleLabel.bottomAnchor, constant: 8),
//                                     subtitleTextView.leftAnchor.constraint(equalTo: userProfileImageView.rightAnchor, constant: 8),
//                                     subtitleTextView.rightAnchor.constraint(equalTo: thumbnailImageView.rightAnchor, constant: 0),
